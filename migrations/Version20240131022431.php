 ...
 */
final class Version20240131022431 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE company CHANGE country_id country_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE company CHANGE country_id country_id INT NOT NULL');
    }
}
