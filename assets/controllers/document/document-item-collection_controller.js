...
export default class extends Controller {
    ...
    addCollectionElement() {
        ...
        item.classList.add('row', 'grid', 'grid-cols-[30px_1fr_1fr_1fr_1fr_1fr_1fr_1fr_1fr]', 'md:grid-cols-[50px_1fr_1fr_1fr_1fr_1fr_1fr_1fr_1fr_1fr_1fr_1fr_1fr_1fr_1fr]', 'gap-2', 'py-2.5', 'border-b', 'border-input-border');
